...
public class minijuegos {
	...
	public static void opcion1 () {//Opciion elegido del jugar contra el jugador//
		...
		palabraelegida = teclado.nextLine();
	...
	public static void opcion2 () {//Opcion para jugar contra la IA//
...
public static void Vidas (int puntuacion) {//Cada vez que pierda vidas se pondra el dibujo correspondiente//
